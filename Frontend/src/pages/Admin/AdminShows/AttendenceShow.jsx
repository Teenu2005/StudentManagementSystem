    ...
    {empty?<main id="main" className="main-cont">
      <div className="contanier">
        <div className="option">
          ...
          <hr />
          <span className="dummy">View Attendence and their Infromation <br />Select Option</span>
          <button id='button-1'  className="button"  onClick={() => handleOptionSelect("view")}>View Attendence</button >
          </div>
        <div className="option">
